...
@section('content')
    ...
    <div class="row">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['url' => '#','id'=>'edit_qst','class'=>'form-horizontal','method'=>'POST']) !!}

                        <div class="form-group">
                            <div class="col-xs-10">
                                {!! Form::hidden('id','',['class' => 'form-control','required'=>'required','id'=>'question_id']) !!}
                            </div>
                        </div>
        ...
        <div class="col-md-12">
            ...
            @if($rows)
                <div class="x_content">
                    <a href="{{route('questionAdd',[$form_id])}}">
                        <button type="button" class="btn btn-default btn-sm"><i class="fa fa-plus green" aria-hidden="true"></i> Новый вопрос</button>
                    </a>
                </div>
                <div class="x_panel">
...
{{--    <script src="/js/jquery.dataTables.min.js"></script>--}}
    ...
    <script>
        ...
        $('#save').click(function(e){
            e.preventDefault();
            let error=0;
            $("#edit_qst").find(":input").each(function() {// проверяем каждое поле ввода в форме
