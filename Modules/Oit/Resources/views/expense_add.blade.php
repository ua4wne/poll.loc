...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ route('expenses') }}">Статьи затрат</a></li>
    ...
    <div class="x_content">
        <h2 class="text-center">Новая статья затрат</h2>
        {!! Form::open(['url' => route('expenseAdd'),'class'=>'form-horizontal','method'=>'POST']) !!}
