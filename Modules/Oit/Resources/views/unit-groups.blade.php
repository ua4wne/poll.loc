...
@section('content')
    ...
    @endif
    <div class="row">
        <div class="modal fade" id="editUnitGroup" tabindex="-1" role="dialog" aria-labelledby="editUnitGroup" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['url' => '#','id'=>'edit_unit-group','class'=>'form-horizontal','method'=>'POST']) !!}

                        <div class="form-group">
                            <div class="col-xs-10">
                                {!! Form::hidden('id','',['class' => 'form-control','required'=>'required','id'=>'unit-group_id']) !!}
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <td style="width:110px;">
                                    <div class="form-group" role="group">
                                        {!! Form::button('<i class="fa fa-edit fa-lg>" aria-hidden="true"></i>',['class'=>'btn btn-success btn-sm btn_edit','type'=>'button','title'=>'Редактироватьть запись','data-toggle'=>'modal','data-target'=>'#editUnitGroup','id'=>$row->id]) !!}
...
@section('user_script')
    ...
    <script>
        ...
        $('#save').click(function(e){
            e.preventDefault();
            let error=0;
            $("#edit_unit-group").find(":input").each(function() {// проверяем каждое поле ввода в форме
            ...
            if(error){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('editUnit-group') }}',
                    data: $('#edit_unit-group').serialize(),
