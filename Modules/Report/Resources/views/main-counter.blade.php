...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('cnt-main-report') }}">{{ $title }}</a></li>
    </ul>
    <!-- END BREADCRUMB -->
    <!-- page content -->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        {!! Form::text('year',date('Y'),['class' => 'form-control','placeholder'=>'ГГГГ','required'=>'required','id'=>'year'])!!}
        ...
        $('#main-report').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $(".text-header").html('<h4>Отчет по потреблению общих счетчиков за ' + year + ' год</h4>');
                    $('.x_content').hide();
